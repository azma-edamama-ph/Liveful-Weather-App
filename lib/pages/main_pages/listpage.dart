...
class _CityListState extends State<CityList> {
  ...
  Future<WeatherResponse> getWeather(long, lat) async {
    final response = await http.get(Uri.parse(
        '${EndPoints.baseUrl}?&lon=$long&lat=$lat&appid=d3bbf9a000350c269dd83714906b91c2&units=metric'));
  ...
  Future<Object> fetchWeather() async {
    ...
    final response = await http.get(Uri.parse(
        '{EndPoints.baseUrl}/group?id=$cittiesIds&APPID=d3bbf9a000350c269dd83714906b91c2&units=metric'));
